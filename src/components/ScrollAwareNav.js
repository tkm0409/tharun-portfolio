...
const ScrollAwareNav = () => {
  ...
  return (
    <>
      <nav className={`fixed top-0 left-0 right-0 transition-transform duration-300 z-50 bg-white bg-opacity-90 backdrop-blur-l ${isVisible ? 'translate-y-0' : '-translate-y-full'}`}>
