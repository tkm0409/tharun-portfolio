            ...
            <div className="container px-4 mx-auto">
                <div className="max-w-3xl mx-auto">
                    <header className="text-center mb-12">
                        <h1 className="text-gray-800 dark:text-gray-200 text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl pb-4">Education</h1>
                        <p className="mx-auto max-w-[700px] text-gray-600 dark:text-gray-400 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">My academic background and qualifications</p>
                    </header>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="px-3 py-1 text-sm font-medium text-green-800 dark:text-green-200 bg-green-100 dark:bg-green-800 rounded-full">Completed</span>
                                </div>
